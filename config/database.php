...
return [
    ...
    */
    ...
    'connections' => [
        ...
        'ris' => [
            'driver' => env('RIS_CONNECTION'),
            'host' => env('RIS_HOST', '127.0.0.1'),
            'port' => env('RIS_PORT', '3306'),
            'database' => env('RIS_DATABASE', 'forge'),
            'username' => env('RIS_USERNAME', 'forge'),
            'password' => env('RIS_PASSWORD', ''),
            'charset' => 'utf8mb4',
            'collation' => 'utf8mb4_unicode_ci',
            'prefix' => '',
            'prefix_indexes' => true,
        ...
        'reports' => [
            'driver' => env('REPORTS_CONNECTION', 'mysql'),
